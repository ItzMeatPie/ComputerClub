...
{
    public partial class Requests_CliSelect : Form
    {

        private DataBase db = new DataBase();

        public Requests_CliSelect()
        {
            InitializeComponent();
        }

        private void Requests_CliSelect_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (SqlCommand command = new SqlCommand(sql, db.getConnection()))
                {
                    ...
                    else
                    {
                        ...
                        Requests_Client requestsForm = Application.OpenForms["Requests_Client"] as Requests_Client;
