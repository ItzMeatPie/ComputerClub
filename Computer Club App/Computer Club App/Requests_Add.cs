...
{
    public partial class Requests_Add : Form
    {
        public DataBase db = new DataBase();
        private string sql = null;

        // Свойства для доступа к полям
        public MaskedTextBox MaskedTextBox2 => maskedTextBox2;
        public TextBox TextBox1 => textBox1;
        public TextBox TextBox2 => textBox2;
        public TextBox TextBox5 => textBox5;
        public TextBox TextBox6 => textBox6;
        public ComboBox ComboBox2 => comboBox2;
        public TextBox TextBox8 => textBox8;
        public TextBox TextBox9 => textBox9;
        public TextBox TextBox10 => textBox10;
        public MaskedTextBox MaskedTextBox1 => maskedTextBox1;
        ...
        private void Requests_Add_Load(object sender, EventArgs e)
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "_Орлов_Д_419_4_УПDataSet.Тарифы". При необходимости она может быть перемещена или удалена.
            this.тарифыTableAdapter.Fill(this._Орлов_Д_419_4_УПDataSet.Тарифы);
