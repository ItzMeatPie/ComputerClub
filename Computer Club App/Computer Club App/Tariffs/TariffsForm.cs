...
using Computer_Club_App.Tariffs;
...
namespace Computer_Club_App
{
    public partial class TariffsForm : Form
    {
        ...
        {
            var tariffs_add_form = new Tariffs_Add();
            tariffs_add_form.Show();
            this.Hide();
        }

        private void Tariffs_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void Tariffs_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        {
            var tarif_update = new Tariffs_Update();
            tarif_update.Show();
        }

        public void LoadData()
        {
            string sql = "SELECT * FROM Тарифы";
        ...
        {
            var tar_del = new Tariffs_Delete();
            tar_del.Show();
            this.Hide();
        }
        ...
        {
            var tar_sel = new Tariffs_Select();
            tar_sel.Show();
        }
