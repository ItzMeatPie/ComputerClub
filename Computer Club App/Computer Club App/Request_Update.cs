...
{
    public partial class Request_Update : Form
    {
        ...
        private void Request_Update_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (SqlCommand command = new SqlCommand(sql, db.getConnection()))
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(comboBox1.Text))
                        command.Parameters.AddWithValue("@Статус_Заявки", comboBox2.Text);
